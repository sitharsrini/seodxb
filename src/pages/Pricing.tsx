  ...
  return (
    <>
      <Helmet prioritizeSeoTags>
        <title>{clampTitle("SEO Pricing Dubai - Transparent Plans for On-Page SEO & AEO | SEODXB")}</title>
        <meta name="description" content="SEO pricing Dubai: Startup from $999/mo, Business from $2,999/mo. Transparent pricing, no lock-in contracts, GEO and AEO." />
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-6 max-w-6xl mx-auto items-start">
          ...
          <div className="relative">
            ...
            >
              ...
              <Button className="w-full rounded-full bg-primary hover:bg-primary/90 text-white py-6 font-semibold text-base" asChild data-testid="button-startup-cta">
                <a href="/contact">Get Started Today <ArrowRight size={16} className="ml-2" /></a>
              </Button>
            </motion.div>
          </div>
          ...
          >
            ...
            <Button className="w-full rounded-full bg-primary hover:bg-primary/90 text-white py-6 font-semibold text-base" asChild data-testid="button-custom-cta">
              <a href="/contact">Get a Quote <ArrowRight size={16} className="ml-2" /></a>
            </Button>
          </motion.div>
        </div>
        ...
        <div className="mt-20 text-center">
          ...
          <Button size="lg" className="rounded-full font-semibold px-8 bg-primary" asChild>
            <a href="/contact">See Plans &amp; Pricing →</a>
          </Button>
        </div>
      </div>
    </div>
