  ...
  return (
    <>
      <Helmet prioritizeSeoTags>
        <title>{clampTitle("SEO Agency UAE - SEO Services Across All 7 Emirates | SEODXB")}</title>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button size="lg" className="rounded-full bg-primary text-white hover:bg-primary/90 font-bold px-8" asChild>
                    <a href="/contact">Get UAE SEO Strategy <ArrowRight size={16} className="ml-2" /></a>
                  </Button>
        ...
        <section className="py-24 bg-black text-white text-center">
          <div className="container mx-auto px-4">
            ...
            <Button size="lg" className="rounded-full bg-[#C8FF00] text-black hover:bg-[#b3e600] font-bold px-10 py-6 text-lg" asChild>
              <a href="/contact">Get My UAE SEO Audit <ArrowRight size={18} className="ml-2" /></a>
            </Button>
          </div>
        </section>
      </div>
